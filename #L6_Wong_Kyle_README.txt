# Activity / Lab / Assignment / Project Title: Lab 6

**[Optional]** If what is being submitted is an individual Lab or Assignment. Otherwise, include a brief one paragraph description about the project.

* *Date Created*: 8th 03 2025
* *Last Modification Date*: 13 03 2025
* *Lab URL*: 
https://git.cs.dal.ca/kwong/cs3172/-/tree/main/labs/lab6
...
* Kyle Wong Ky607453@dal.ca - Author
...
Testing:
Console log to check through it
Physical tests to press links in display

Icons were made by me on google drawing 
